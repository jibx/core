...
import com.sosnoski.ws.library.jibx2wsdl.AddDuplicateFault;
 ...
 */
public class LibraryServer2Impl extends LibraryServer2Skeleton
{
    private final LibraryServer2 m_server;
    
    public LibraryServer2Impl() {
        m_server = new LibraryServer2();
    }
